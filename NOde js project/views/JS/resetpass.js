...
async function resetPass(event) {
    ...
    await axios.post('http://127.0.0.1:4000/password/forgotpassword', resetObj)
        .then((response) => {
...
//     await axios.get(`http://127.0.0.1:4000/password/forgotpassword/${uuid}`).then(response => console.log(response.data.message))
